...
def balls_func():
    ...
    i = 1
    while True:
#        x_move_1 = sol_func()[i+1, 0] - sol_func()[i, 0]
#        y_move_1 = sol_func()[i+1, 2] - sol_func()[i, 2]
    
#        x_coords_2 = sol_func()[i, 4]
#        y_coords_2 = sol_func()[i, 6]
#        
#        x_coords_3 = sol_func()[i, 8]
#        y_coords_3 = sol_func()[i, 10]
#        
#        x_coords_4 = sol_func()[i, 12]
#        y_coords_4 = sol_func()[i, 14]
#        
#        x_coords_5 = sol_func()[i, 16]
#        y_coords_5 = sol_func()[i, 18]

        canvas.move(ball_1, sol_func()[i+1, 0] - sol_func()[i, 0], 
                    sol_func()[i+1, 2] - sol_func()[i, 2])
        
        canvas.move(ball_2, sol_func()[i+1, 4] - sol_func()[i, 4], 
                    sol_func()[i+1, 6]- sol_func()[i, 6])
#        
#        canvas.move(ball_3, sol_func()[i+1, 8]- sol_func()[i, 8], 
#                    sol_func()[i+1, 10]- sol_func()[i, 10])
#        
#        canvas.move(ball_4, sol_func()[i+1, 12]- sol_func()[i, 12], 
#                    sol_func()[i+1, 14]- sol_func()[i, 14])
#        
        canvas.move(ball_5, sol_func()[i+1, 16]- sol_func()[i, 16], 
                    sol_func()[i+1, 18]- sol_func()[i, 18])
